// Función para crear una página de categoría dinámica
function crearPaginaCategoria(nombreCategoria) {
  return `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>${nombreCategoria} - Micasita Multirubro</title>
...
<body>
  ...
  <main class="wrap">
    ...
    <h1 id="titulo-categoria">${nombreCategoria}</h1>
  ...
  <script>
    const CATEGORIA_NOMBRE = '${nombreCategoria}';
